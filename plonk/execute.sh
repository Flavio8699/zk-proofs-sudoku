...
# Generate .zkey file
snarkjs plonk setup ${CIRCUIT}.r1cs ../ptau/powersOfTau28_hez_final_${PTAU}.ptau ${CIRCUIT}_0000.zkey
...
# Generating ZK-proof
start_time=$(date +%s.%N)
snarkjs plonk prove ${CIRCUIT}_0000.zkey ${CIRCUIT}_js/witness.wtns proof.json public.json
end_time=$(date +%s.%N)
