...
template Sudoku() {
    ...
    // Check if the numbers of the solved sudoku are >=1 and <=4
    // Each number in the solved sudoku is checked to see if it is >=1 and <=4

    component getone[4][4];
    component letnine[4][4];
    ...
    // Check if each square in solved has all the numbers from 1 to 4, both included
